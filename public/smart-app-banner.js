      ...
      1: [
        function(a, d, b) {
          var e = a('object-assign'),
            ...
            n = a('ua-parser-js'),
            k =
              (navigator.language || navigator.userLanguage || navigator.browserLanguage).slice(
                -2
              ) || 'us',
          ...
          a = function(a) {
            ...
            if (this.type && this.options.store[this.type]) {
              ...
              a ||
                ...
                d ||
                (e(this, g[this.type]),
                !this.appId && 'IOS' === c.os.name && 'Safari' === c.browser.name) ||
        ...
        function(a, d, b) {
          ...
          d.exports = (function() {
            try {
              ...
              return 'abcdefghijklmnopqrst' !== Object.keys(Object.assign({}, b)).join('')
                ? !1
                : !0;
            } catch (r) {
              return !1;
      ...
      7: [
        function(a, d, b) {
          (function(a, c) {
                      ...
                      for (l = 0; l < m.length; l++)
                        (q = g[++f]),
                          ...
                          'object' === typeof h && 0 < h.length
                            ? 2 == h.length
                              ? (this[h[0]] = 'function' == typeof h[1] ? h[1].call(this, q) : h[1])
                              : 3 == h.length
                              ? (this[h[0]] =
                                  'function' !== typeof h[1] || (h[1].exec && h[1].test)
                                    ...
                                    : c)
                              : 4 == h.length &&
                                (this[h[0]] = q ? h[3].call(this, q.replace(h[1], h[2])) : c)
                            : (this[h] = q ? q : c);
                  e += 2;
                }
              },
            ...
            'undefined' !== typeof b
              ? ('undefined' !== typeof d && d.exports && (b = d.exports = g), (b.UAParser = g))
              : a && (a.UAParser = g);
